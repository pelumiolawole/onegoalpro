...
// Collect timezone silently in the background — not during the interview
useEffect(() => {
async function saveTimezone() {
try {
const tz = Intl.DateTimeFormat().resolvedOptions().timeZone
if (tz) {
await api.profile.saveTimezone(tz)
}
} catch {}
}
saveTimezone()
...
```
      <h1 className="font-display text-4xl text-[#F59E0B] mb-4">
        The Discovery Interview
      </h1>
      <p className="text-[#A09690] text-lg leading-relaxed mb-4">
        Before we build your strategy, we need to understand what you actually want —
        not the goal you think you should have, but the real one.
      </p>
      <p className="text-[#7A6E65] mb-10">
        This is a conversation. Answer honestly. Take your time.
      </p>
